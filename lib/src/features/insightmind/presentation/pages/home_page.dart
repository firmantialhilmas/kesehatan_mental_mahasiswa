...
import '../../providers/screening_status_provider.dart'; // ✅ IMPORT BARU
...
class HomePage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // ✅ PAKAI screeningStatusProvider, BUKAN questionnaire.isComplete
    final hasCompletedScreening = ref.watch(screeningStatusProvider);
    ...
    final List<Widget> pages = [
      _buildHomeContent(context, ref, user, hasCompletedScreening), // ✅ Pass status
      const DashboardPage(),
      const ProfilePage(),
    ];
  ...
  Widget _buildHomeContent(BuildContext context, WidgetRef ref, dynamic user, bool hasCompletedScreening) {
    return Scaffold(
      backgroundColor: creamHighlight,
